...
public class ParagraphVectorsClassifierExample {
	...
	final ParagraphVectorsClassifierExample app = new ParagraphVectorsClassifierExample();
	...
	final MeansBuilder meansBuilder = new MeansBuilder(
		(InMemoryLookupTable<VocabWord>) this.paragraphVectors.getLookupTable(), this.tokenizerFactory);
	...
	while (unClassifiedIterator.hasNextDocument()) {
	     ...
	     */
	    ParagraphVectorsClassifierExample.log
		    .info("Document '" + document.getLabel() + "' falls into the following categories: ");
	...
	this.iterator = new FileLabelAwareIterator.Builder().addSourceFolder(resource.getFile()).build();
