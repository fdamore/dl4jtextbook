...
public class Word2VecRawTextExample {
	...
	final String filePath = new ClassPathResource("raw_sentences.txt").getFile().getAbsolutePath();

	Word2VecRawTextExample.log.info("Load & Vectorize Sentences....");
	// Strip white space before and after for each line
	final SentenceIterator iter = new BasicLineIterator(filePath);
	...
	Word2VecRawTextExample.log.info("Building model....");
	...
	Word2VecRawTextExample.log.info("Fitting Word2Vec model....");
	vec.fit();

	Word2VecRawTextExample.log.info("Writing word vectors to text file....");
	...
	// Word Vectors.
	Word2VecRawTextExample.log.info("Closest Words:");
	final Collection<String> lst = vec.wordsNearest("day", 10);
